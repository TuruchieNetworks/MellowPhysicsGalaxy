...
import { useCannonBox, useCannonSphere, useMultiFacedCannonBox } from '../hooks/UseCannonGeometry';
import { useCannonGroundPlane, useGroundBoxContactMaterial, useCannonGround, useGroundSphereContactMaterial } from '../hooks/UseCannonGround';
...
const FallingInstancedSand = ({ height = window.innerHeight, width = window.innerWidth, particleCount = 500 }) => {
    ...
    const { groundBody, groundMesh, groundSphereContactMat } = useCannonGround();
...
export default FallingInstancedSand;